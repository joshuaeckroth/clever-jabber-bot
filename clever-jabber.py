...
def test_for_xpath(driver, locator):
    try:
...
def wait_for_clever_response(driver):
    try:
        WebDriverWait(driver, 10).until(lambda driver: test_for_xpath(driver, "//span[@id='respArea']/table/tbody/tr[2]/td/table/tbody/tr[2]"))
        sleep(10)
        elem = driver.find_element_by_id("typArea")
        return elem
    except Exception, e:
        print "Exception: ", e
        return None
